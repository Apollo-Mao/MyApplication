...
import com.example.myapplication8.adapter.PlanetGridAdapter;
import com.example.myapplication8.bean.Planet;
...
public class GridViewActivity extends AppCompatActivity {
    ...
    class DividerSelectedListener implements AdapterView.OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            int dividerPad = Utils.dip2px(com.example.myapplication8.GridViewActivity.this, 2); // 定义间隔宽度为2dp
            ...
            gv_planet.setColumnWidth(Utils.dip2px(com.example.myapplication8.GridViewActivity.this, 120));  // 设置每列宽度为120dp
