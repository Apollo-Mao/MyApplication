...
public class LaunchFragment extends Fragment {
    ...
    // 获取该碎片的一个实例
    public static com.example.myapplication8.fragment.LaunchFragment newInstance(int position, int image_id) {
        com.example.myapplication8.fragment.LaunchFragment fragment = new com.example.myapplication8.fragment.LaunchFragment(); // 创建该碎片的一个实例
